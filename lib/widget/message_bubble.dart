...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget messageContent = DisplayMessageType(
      ...
      color: isMe ? Colors.white : Colors.black87, // Your selected line
      isReply: false, // This is the main message body
    );

    // 1. Main message content (text + timestamp) - for sizing and display
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Display the main message and timestamp again, but this time as part of the visible content
    ...
    // --- The rest of your existing Row structure for avatars and alignment ---
