...
import 'package:chatapp/widget/friend_widget.dart';
import 'package:chatapp/widget/group_setting_listTile.dart';
...
class _GroupSettingsScreenState extends State<GroupSettingsScreen> {
  String getGroupAdminsNames({
    ...
    if (groupProvider.groupMembersList.isEmpty) {
      ...
      List<String> groupAdminsNamesList =
          groupAdminsList.map((groupAdmin) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: const Text('Group Settings')),
